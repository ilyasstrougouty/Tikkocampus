...
- **Windows (.exe)**: [Tikkocampus-Setup-1.1.7.exe](https://github.com/ilyasstrougouty/Tikkocampus/releases/download/v1.1.7/Tikkocampus-Setup-1.1.7.exe)
- **macOS (.dmg)**: [Download Tikkocampus-1.1.7-arm64.dmg](https://github.com/ilyasstrougouty/Tikkocampus/releases/download/v1.1.7/Tikkocampus-1.1.7-arm64.dmg)
- **Linux (AppImage)**: [Download Tikkocampus-1.1.7.AppImage](https://github.com/ilyasstrougouty/Tikkocampus/releases/download/v1.1.7/Tikkocampus-1.1.7.AppImage)
